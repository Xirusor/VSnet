...
# my_resume = '/home/zhangconghao/VUnet_1/results/ablation_ux/fold_5ckpt.t7'
my_resume = '/home/zhangconghao/VUnet_1/results/ablation_ux/dec-5.t7'
my_test_fold = hhh
my_test = 1
...
def test_EBAM(data_loader, net):
    ...
    f = feats.reshape(total,-1)
    t = targs.reshape(-1, 1)
    # from sklearn.metrics import silhouette_score
    # print('silhouette_score', silhouette_score(f, targs))
    ...
    embeddings_tsne = TSNE()._fit(f)
    plt.scatter(embeddings_tsne[:,0], embeddings_tsne[:,1], s=150, c=t, cmap=plt.cm.get_cmap('jet', 2), marker='.', alpha=1.0)
